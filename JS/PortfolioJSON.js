...
[
    ...
    { "id": 6, "media": "Illustration", "name": "7", "display": false, "location":"../Portfolio/Illustration/Discobug",
    ...
    { "id": 9, "media": "Illustration", "name": "5", "display": false, "location":"../Portfolio/Illustration/Ghost Pepper",
    ...
    { "id": 10, "media":"Sketch", "name":"1", "display": false, "location":"../Portfolio/Sketch/Inktober2023",
    ...
    { "id": 22, "media": "3D", "name":"3", "display": false, "location":"../Portfolio/3D/Modular",
    ...
    { "id": 31, "media": "Sketch", "name":"4", "display": false, "location":"../Portfolio/Sketch/Mailet",
    ...
    { "id": 37, "media": "Sketch", "name":"9", "display": false, "location":"../Portfolio/Sketch/AnnoyingBird",
    ...
    { "id": 40, "media": "Sketch", "name":"10", "display": true, "location":"../Portfolio/Sketch/PenguinProject",
        "actualname":"Penguin Project",
        "description": "An ongoing project of mine is to draw as many penguins from various media as I can in a sketched illustration! Its really fun, and it also gives me"+
        "an excuse to draw my favorite animal. These are some highlights of that project",
        "captions":["This specific design is from 'The Super Mario Bros. Movie'","These specific designs are from 'Pennys Big Breakaway'","This specific design is from 'Super Auto Pets'","This specific design is from 'Quartz Quest'"],
        "onlyImages":true,
    },
    { "id": 41, "media": "Illustration", "name":"22", "display": true, "location":"../Portfolio/Illustration/STD5",
        "actualname":"Seal's Triassic Drama 5",
        "description": "This is an online competition where participants are placed in a group and compete in various challenges. I was one of the main artists on my team, The Spore Starwalkers, a Hollywood talent agency",
        "captions":[" I developed a brand guide for my team to use for submission materials to save time and establish visual consistency.",
            "An example of the brand guide being used in a advertising pamphlet",
            "We we're also required to develop a team mascot. We decided on Guy Funlin, a former Z-lister celebrity wanting to re-enter the acting business",
            "Concept art",
            "Concept art",
            "For a future challenge, we also designed another character to act as additional talent. Initial concept done by @saasigersoos",
            "A comic page sample featuring Vannisus. It was required to use visual assets from the mobile game 'Plants vs Zombies Heroes' but editing assets was allowed. Almost everything here is edited from existing assets",
            "The initial storyboard I designed"],
        "onlyImages":true,
    },
]
